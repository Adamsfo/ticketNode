...
router.post('/eventosuite/:id/fotos/:fotoId/principal', authenticate, EventoSuiteFotoController.setPrincipal);
router.post('/eventosuite/:id/fotos/:fotoId/mover', authenticate, EventoSuiteFotoController.mover);
router.delete('/eventosuite/:id/fotos/:fotoId', authenticate, EventoSuiteFotoController.remove);
