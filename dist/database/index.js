...
const EventoSuiteLimpeza_1 = require("../models/EventoSuiteLimpeza");
...
const ReservaSuiteItemServico_1 = require("../models/ReservaSuiteItemServico");
...
const ReservaHospedeDocumento_1 = require("../models/ReservaHospedeDocumento");
const IntegrationProviderConfig_1 = require("../models/IntegrationProviderConfig");
...
(async () => {
    try {
        ...
        (0, ReservaIdentificadorExterno_1.ReservaIdentificadorExternoInit)(connection);
        (0, ReservaOrigemFinanceira_1.ReservaOrigemFinanceiraInit)(connection);
        (0, ReservaOrigemPayload_1.ReservaOrigemPayloadInit)(connection);
        (0, ReservaHospedeDocumento_1.ReservaHospedeDocumentoInit)(connection);
        (0, IntegrationProviderConfig_1.IntegrationProviderConfigInit)(connection);
        (0, IntegrationProviderState_1.IntegrationProviderStateInit)(connection);
        (0, IntegrationSyncExecution_1.IntegrationSyncExecutionInit)(connection);
        (0, IntegrationEntitySyncEvent_1.IntegrationEntitySyncEventInit)(connection);
        ...
        (0, ReservaSuiteItemServico_1.ReservaSuiteItemServicoInit)(connection);
        (0, ReservaHospedagemTaxaAdicional_1.ReservaHospedagemTaxaAdicionalInit)(connection);
        (0, EventoSuiteLimpeza_1.EventoSuiteLimpezaInit)(connection);
