...
const { login, addLogin, enviarEmailRecuperacaoSenha, varificaAtivarConta, enviaCodigoAtivacao, visitasNoSite, loginEmailCodigo } = require('../controllers/AuthController');
